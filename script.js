...
contactForm.addEventListener("submit", function (e) {
  ...
  const url = `https://api.telegram.org/bot${botToken}/sendMessage?chat_id=${chatId}&parse_mode=Markdown&text=${encodeURIComponent(text)}`
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (dateInput) {
    ...
    // Force the date input to show the calendar picker
    dateInput.style.colorScheme = "light dark"
    dateInput.style.position = "relative"

    // Ensure the calendar icon is always visible
